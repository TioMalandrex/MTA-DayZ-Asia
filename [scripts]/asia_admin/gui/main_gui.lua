function gui()
	...
	window = guiCreateWindow((screenW - 616) / 2, (screenH - 518) / 2, 616, 518, "Painel Admin", false)
	...
	buttonDutyMode = guiCreateButton(138, 16, 89, 15, "Modo Serviço", false, tabPlayers)
	...
	labelBackPackSlots = guiCreateLabel(154, 323, 262, 16, "Slots da Mochila: N/A", false, tabPlayers)
	...
	buttonMute = guiCreateButton(423, 75, 72, 17, "mutar", false, tabPlayers)
	...
	function getGridListInfo()
		...
		if (guiGridListGetSelectedItem(gridlistPlayers1) ~= -1) then
			...
			guiSetText(labelBackPackSlots,"Slots da Mochila: N/A")
