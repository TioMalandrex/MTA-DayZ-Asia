...
login.window[1] = guiCreateWindow(sW*0.4, sH*0.384, 243, 152, "Por favor, faça login para continuar!", false)
...
register.window[1] = guiCreateWindow(sW*0.4, sH*0.384, 243, 237, "Registre sua conta.", false)
...
register.label[4] = guiCreateLabel(16, 153, 211, 15, "Confirmar Senha:", false, register.window[1])
...
register.button[1] = guiCreateButton(10, 198, 107, 29, "Criar", false, register.window[1])
...
language.staticimage[2] = guiCreateStaticImage(15, 25, 300, 300, "logo.png", false)
...
addEventHandler("onClientResourceStart",resourceRoot,function()
    if (not getElementData(localPlayer, "logedin")) then
        ...
        loginped = createPed(71,-1440,-1503.599609375,79.699996948242,157.994018)
...
function lowScreenWarn()
    ...
    if (x < 1024) and (y < 768) then
        outputChatBox("AVISO: SUA RESOLUÇÃO DE TELA É MUITO BAIXA, ALGUNS ELEMENTOS DA INTERFACE PODEM ESTAR MAL POSICIONADOS!",200,10,10);
    end
end
